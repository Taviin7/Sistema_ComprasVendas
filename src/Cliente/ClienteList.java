...
public class ClienteList extends javax.swing.JFrame {
    ...
    public void preencherTabela() {
        ...
        DefaultTableModel tabelaCliente = (DefaultTableModel) tbl_Clientes.getModel();
    ...
    private void initComponents() {
        ...
        tbl_Clientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Rua", "Nº", "Bairro", "Cidade", "CEP", "UF", "Email", "Telefone"
            }
        ));
    ...
    private void btn_VoltarCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_VoltarCadastroActionPerformed
        CadastroCliente cc = new CadastroCliente(); // Cria uma nova instância do formulário
        cc.setVisible(true); //abri o forms
