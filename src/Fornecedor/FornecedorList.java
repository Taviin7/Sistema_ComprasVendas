 ...
 */
public class FornecedorList extends javax.swing.JFrame {
    ...
    public void preencherTabela() {
        ...
        List<Fornecedor> listaFornecedor = fDAO.listarFornecedores();

        DefaultTableModel tabelaFornecedor = (DefaultTableModel) tbl_Fornecedor.getModel();
    ...
    private void initComponents() {
        ...
        lbl_Titulo.setText("Lista de Fornecedores");
        ...
        tbl_Fornecedor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nome", "Nome Fantasia", "CNPJ", "Rua", "Nº", "Bairro", "Cidade", "CEP", "UF", "Email", "Telefone"
            }
        ));
    ...
    private void btn_VoltarCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_VoltarCadastroActionPerformed
        CadastroFornecedor fn = new CadastroFornecedor(); // Cria uma nova instância do formulário
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FornecedorList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
